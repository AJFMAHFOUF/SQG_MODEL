...
if var == 'phi':
	...
	cs = ax.contour(lon2,lat2,field*1E6,np.arange(-150,175,25),transform=ccrs.PlateCarree(),colors='black')
	cs = ax.contourf(lon2,lat2,field*1E6,np.arange(-150,175,25),transform=ccrs.PlateCarree(),cmap='seismic')
...
plt.savefig('../plots/BVE_'+var+'_500_T'+trunc+'_step_'+nstep+'_expid_'+expid+'_new.pdf')
plt.show()

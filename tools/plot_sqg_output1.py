...
lon1,lat1,vor,u,v,psi,phi,t=np.loadtxt('../data_out/SQG_T'+trunc+'_lev_'+level+'_step_'+nstep+'_expid_'+expid+'.dat',unpack=True)
...
cbar.ax.tick_params()
#level='650'
plt.title('SQG '+var+' '+level+' hpa '+nstep+'h - T'+trunc+' expid='+expid)
plt.savefig('../plots/SQG_'+var+'_'+level+'_T'+trunc+'_step_'+nstep+'_expid_'+expid+'_new.pdf')
plt.show()

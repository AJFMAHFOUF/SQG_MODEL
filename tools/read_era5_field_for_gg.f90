program read_era5_for_gg
 ...
 integer, parameter :: nfields=6, niter=(nfields-1)*10 ! number of fields to be interpolated
...
!  
 open (unit=55,file=path1//'vorticity_'//date//'_'//hour//'_'//level//'_025res.dat',status='old')
! open (unit=65,file=path1//'divergence_'//date//'_'//hour//'_'//level//'_025res.dat',status='old')
 open (unit=65,file=path1//'geopotential_'//date//'_'//hour//'_'//level//'_025res.dat',status='old')
 open (unit=75,file=path1//'uwind_'//date//'_'//hour//'_'//level//'_025res.dat',status='old')
 open (unit=85,file=path1//'vwind_'//date//'_'//hour//'_'//level//'_025res.dat',status='old')
 open (unit=95,file=path1//'potential_vorticity_'//date//'_'//hour//'_'//level//'_025res.dat',status='old')
 open (unit=105,file=path1//'temperature_'//date//'_'//hour//'_'//level//'_025res.dat',status='old')
! open (unit=125,file=path1//'vertical_velocity_'//date//'_'//hour//'_'//level//'_025res.dat',status='old')
! 
! Open output files - Gaussian (quadratic) grid on selected truncation
! 
 open (unit=56,file=path2//'VOR_'//date//'_'//hour//'_'//level//'_T'//trunc//'gg.dat',status='unknown')
! open (unit=66,file=path2//'DIV_'//date//'_'//hour//'_'//level//'_T'//trunc//'gg.dat',status='unknown')
 open (unit=66,file=path2//'PHI_'//date//'_'//hour//'_'//level//'_T'//trunc//'gg.dat',status='unknown')
 open (unit=76,file=path2//'U_'//date//'_'//hour//'_'//level//'_T'//trunc//'gg.dat',status='unknown')
 open (unit=86,file=path2//'V_'//date//'_'//hour//'_'//level//'_T'//trunc//'gg.dat',status='unknown')
 open (unit=96,file=path2//'PV_'//date//'_'//hour//'_'//level//'_T'//trunc//'gg.dat',status='unknown')
 open (unit=106,file=path2//'T_'//date//'_'//hour//'_'//level//'_T'//trunc//'gg.dat',status='unknown')
! open (unit=126,file=path2//'W_'//date//'_'//hour//'_'//level//'_T'//trunc//'gg.dat',status='unknown')
!
